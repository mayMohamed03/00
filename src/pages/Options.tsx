  ...
  return (
    <div className={styles.options}>
      <div className={styles.itSenior}>
        <img className={styles.itSeniorChild} alt="" src="/rectangle.svg" />
      ...
      <div className={styles.vectorParent}>
        ...
        <div className={styles.apply}>
          ...
          <div className={styles.icon}>
            ...
            <img className={styles.iconChild} alt="" src="/rectangle.svg" />
          </div>
        </div>
        <div className={styles.delete}>
          <div className={styles.text23}>Delete</div>
          <img className={styles.buttonhover} alt="" src="/icon.svg" />
        </div>
