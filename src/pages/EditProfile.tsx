  ...
  return (
    <div className={styles.editProfile}>
      <div className={styles.aboutMe}>
        <img className={styles.aboutMeChild} alt="" src="/rectangle.svg" />
      ...
      <div className={styles.education}>
        ...
        <img className={styles.editIcon} alt="" src="/button.svg" />
        <img className={styles.iconEducation} alt="" src="/icon.svg" />
      ...
      <div className={styles.appreciation}>
        ...
        <div className={styles.iconAppreciation}>
          ...
          <img className={styles.rectangleIcon3} alt="" src="/rectangle.svg" />
      ...
      <div className={styles.resume}>
        ...
        <div className={styles.jametKudasiCvUiuxDesi}>
          ...
          <img className={styles.buttonIcon3} alt="" src="/icon.svg" />
      ...
      <div className={styles.skill}>
        <img className={styles.rectangleIcon4} alt="" src="/rectangle.svg" />
        ...
        <img className={styles.iconResume} alt="" src="/icon.svg" />
        <img className={styles.lineIcon1} alt="" src="/line.svg" />
        <b className={styles.text4}>Skill</b>
      </div>
      <div className={styles.imege1}>
        <img className={styles.rectangleIcon10} alt="" src="/rectangle.svg" />
      ...
      <div className={styles.groupParent}>
        ...
        <div className={styles.button1}>
          <img className={styles.buttonIcon8} alt="" src="/button.svg" />
