  ...
  return (
    <div className={styles.addPost}>
      <div className={styles.menuBar}>
        <img className={styles.rectangleIcon} alt="" src="/rectangle9.svg" />
        <img className={styles.iconCamera} alt="" src="/icon-camera1.svg" />
      ...
      <div className={styles.back}>
        ...
        <img className={styles.imegeIcon} alt="" src="/line1.svg" />
      </div>
