  ...
  return (
    <div className={styles.notifications}>
      ...
      <div className={styles.twitterInc}>
        <img className={styles.twitterIncChild} alt="" src="/rectangle35.svg" />
        <img className={styles.optionsIcon} alt="" src="/options3.svg" />
        <img className={styles.optionsIcon2} alt="" src="/options2.svg" />
        <div className={styles.seeJob}>
          <img className={styles.buttonIcon1} alt="" src="/button11.svg" />
      ...
      <div className={styles.facebookInc}>
        ...
        <img className={styles.optionsIcon2} alt="" src="/options2.svg" />
        <div className={styles.seeJob}>
          <img className={styles.seeJobChild} alt="" src="/rectangle36.svg" />
      ...
      <div className={styles.googleInc}>
        <img className={styles.googleIncChild} alt="" src="/rectangle37.svg" />
        <img className={styles.optionsIcon5} alt="" src="/options5.svg" />
        ...
        <img className={styles.optionsIcon6} alt="" src="/options6.svg" />
        <div className={styles.applicationDetails}>
          <img className={styles.buttonIcon2} alt="" src="/button12.svg" />
