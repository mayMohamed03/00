    ...
    <div className={styles.uploadCv}>
      ...
      <div className={styles.button1}>
        <div className={styles.button2}>
          <img className={styles.rectangleIcon} alt="" src="/rectangle88.svg" />
          <b className={styles.text}>Apply Now</b>
        </div>
      </div>
      <TextArea textArae="/textarae.svg" />
      <div className={styles.jametKudasiCvUiuxDesi}>
        <img className={styles.rectangleIcon1} alt="" src="/rectangle76.svg" />
        ...
        <div className={styles.pdf}>
          ...
          <img className={styles.imegeIcon} alt="" src="/rectangle33.svg" />
          <img className={styles.imegeIcon1} alt="" src="/vector.svg" />
          <div className={styles.text2}>PDF</div>
        </div>
        <div className={styles.button3}>
          <img className={styles.rectangle} alt="" src="/icon18.svg" />
      ...
      <div className={styles.rectangleParent}>
        ...
        <img className={styles.imegeIcon2} alt="" src="/imege61@2x.png" />
      </div>
      <div className={styles.rectangleParent}>
        <div className={styles.rectangle2} />
