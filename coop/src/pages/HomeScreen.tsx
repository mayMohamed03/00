    ...
    <div className={styles.homeScreen}>
      <div className={styles.jobRecommendation}>
        ...
        <div className={styles.googleInc}>
          <img className={styles.buttonIcon} alt="" src="/rectangle6.svg" />
          ...
          <div className={styles.save}>
            ...
            <img className={styles.buttonIcon1} alt="" src="/rectangle4.svg" />
          </div>
      ...
      <img className={styles.imegeIcon} alt="" src="/imege42.svg" />
      <div className={styles.button1}>
        <img className={styles.buttonIcon2} alt="" src="/button17.svg" />
        <img className={styles.buttonIcon3} alt="" src="/button18@2x.png" />
      ...
      <div className={styles.button6}>
        ...
        <img className={styles.imegeIcon1} alt="" src="/imege43@2x.png" />
      </div>
      <img className={styles.imegeIcon2} alt="" src="/imege44@2x.png" />
    </div>
  );
};
