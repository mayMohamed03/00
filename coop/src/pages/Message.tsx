  ...
  return (
    <div className={styles.message}>
      <div className={styles.button}>
        ...
        <img className={styles.imegeIcon} alt="" src="/imege22@2x.png" />
      ...
      <div className={styles.button1}>
        ...
        <img className={styles.imegeIcon1} alt="" src="/imege23@2x.png" />
        <div className={styles.text6}>30m ago</div>
      </div>
      <div className={styles.button2}>
        <img className={styles.imegeIcon2} alt="" src="/imege24@2x.png" />
      ...
      <img className={styles.buttonIcon} alt="" src="/button6.svg" />
      <div className={styles.button3}>
        <img className={styles.imegeIcon2} alt="" src="/imege25@2x.png" />
        <div className={styles.text7}>I saw the IT student vac...</div>
        <b className={styles.text8}>Megan Rapinoe</b>
        <div className={styles.text12}>01:00 pm</div>
      </div>
      <div className={styles.button4}>
        <img className={styles.imegeIcon2} alt="" src="/imege26@2x.png" />
        <div className={styles.text7}>I saw the IT Student vac...</div>
        <b className={styles.text8}>Alessandro Bastoni</b>
        <div className={styles.text12}>06:00 pm</div>
      </div>
      <div className={styles.button5}>
        <img className={styles.imegeIcon5} alt="" src="/imege27@2x.png" />
      ...
      <div className={styles.search}>
        <img className={styles.searchChild} alt="" src="/rectangle18.svg" />
        <img className={styles.iconSearch} alt="" src="/icon-search.svg" />
        <div className={styles.searchMessage}>Search message</div>
      </div>
      <img className={styles.buttonIcon1} alt="" src="/options2.svg" />
