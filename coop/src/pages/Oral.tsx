    ...
    <div className={styles.oral}>
      ...
      <div className={styles.addLanguage}>
        <div className={styles.language}>
          <img className={styles.languageChild} alt="" src="/rectangle65.svg" />
          <img className={styles.languageItem} alt="" src="/line14.svg" />
      ...
      <div className={styles.popUp}>
        ...
        <img className={styles.popUpChild} alt="" src="/rectangle67.svg" />
