    ...
    <div className={styles.post}>
      <div className={styles.arnoldLeonardo}>
        ...
        <div className={styles.arnoldLeonardo1}>
          <img className={styles.imegeIcon} alt="" src="/imege2@2x.png" />
        ...
        <div className={styles.likeCommentAndShared}>
          ...
          <div className={styles.like}>
            ...
            <div className={styles.button}>
              <div className={styles.button} />
              <img className={styles.imegeIcon1} alt="" src="/imege3.svg" />
            </div>
            <div className={styles.text2}>12</div>
          </div>
          <div className={styles.comment}>
            <img className={styles.button} alt="" src="/icon1.svg" />
            <div className={styles.text2}>10</div>
          </div>
          <div className={styles.comment1}>
            <div className={styles.text4}>2</div>
            <img className={styles.icon3} alt="" src="/icon2@2x.png" />
          </div>
        </div>
      ...
      <div className={styles.optionsParent}>
        <img className={styles.optionsIcon1} alt="" src="/options1.svg" />
        <div className={styles.back}>
          <div className={styles.back} />
          <img className={styles.imegeIcon2} alt="" src="/imege4.svg" />
        </div>
      </div>
      <img className={styles.imegeIcon3} alt="" src="/imege5@2x.png" />
      ...
      <div className={styles.rectangleParent}>
        ...
        <img className={styles.imegeIcon4} alt="" src="/imege6@2x.png" />
      </div>
    </div>
  );
};
