  ...
  return (
    <div className={styles.sharedAJob}>
      <div className={styles.menuBar}>
        <img className={styles.menuBarChild} alt="" src="/rectangle9.svg" />
      ...
      <div className={styles.appleInc}>
        <img className={styles.appleIncChild} alt="" src="/rectangle11.svg" />
      ...
      <img className={styles.imegeIcon} alt="" src="/imege12@2x.png" />
    </div>
  );
};
