...
import styles from "./RemoveWorkExperience.module.css";

const RemoveWorkExperience: FunctionComponent = () => {
  return (
    <div className={styles.removeWorkExperience}>
      ...
      <div className={styles.popUp}>
        ...
        <img className={styles.popUpItem} alt="" src="/rectangle38.svg" />
        ...
        <b className={styles.text17}>Remove Work Experience ?</b>
