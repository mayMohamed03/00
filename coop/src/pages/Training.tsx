    ...
    <div className={styles.training}>
      ...
      <div className={styles.popularJobs}>
        <div className={styles.googleInc}>
          <img className={styles.googleIncChild} alt="" src="/rectangle2.svg" />
          <div className={styles.logoGoogle}>
            <div className={styles.logoGoogleChild} />
            <img className={styles.imegeIcon} alt="" src="/imege7@2x.png" />
          </div>
          ...
          <div className={styles.save}>
            ...
            <img className={styles.saveItem} alt="" src="/rectangle4.svg" />
          </div>
      ...
      <div className={styles.googleInc1}>
        ...
        <div className={styles.logoGoogle}>
          <div className={styles.logoGoogleChild} />
          <img className={styles.imegeIcon1} alt="" src="/imege8@2x.png" />
        </div>
      ...
      <div className={styles.googleInc2}>
        ...
        <div className={styles.logoGoogle2}>
          ...
          <img className={styles.imegeIcon2} alt="" src="/imege9@2x.png" />
        </div>
        <div className={styles.fullTime1}>
          <div className={styles.fullTimeItem} />
      ...
      <div className={styles.optionsParent}>
        <img className={styles.optionsIcon} alt="" src="/options1.svg" />
        <div className={styles.saveChild}>
          <div className={styles.saveChild} />
          <img className={styles.lineIcon} alt="" src="/imege4.svg" />
        </div>
      </div>
      ...
      <div className={styles.rectangleParent}>
        ...
        <img className={styles.imegeIcon3} alt="" src="/imege6@2x.png" />
      </div>
    </div>
  );
};
