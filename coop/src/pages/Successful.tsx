  ...
  return (
    <div className={styles.successful}>
      <div className={styles.findASimilarJob}>
        <img className={styles.buttonIcon} alt="" src="/button21.svg" />
      ...
      <div className={styles.jametKudasiCvUiuxDesi}>
        <img className={styles.rectangleIcon} alt="" src="/rectangle69.svg" />
        <div className={styles.pdf}>
          ...
          <img
            ...
            src="/rectangle24.svg"
          />
          <img className={styles.imegeIcon} alt="" src="/line5.svg" />
      ...
      <div className={styles.buttonParent}>
        <img className={styles.buttonIcon2} alt="" src="/button23.svg" />
        <div className={styles.button1}>
          <div className={styles.button1} />
          <img className={styles.lineIcon} alt="" src="/line18.svg" />
        </div>
      </div>
      <div className={styles.rectangleParent}>
        ...
        <img className={styles.imegeIcon1} alt="" src="/imege6@2x.png" />
      </div>
    </div>
  );
};
