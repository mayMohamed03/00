  ...
  return (
    <div className={styles.myConnection}>
      <div className={styles.googleInc}>
        <img className={styles.googleIncChild} alt="" src="/rectangle72.svg" />
        ...
        <img className={styles.imegeIcon} alt="" src="/imege50@2x.png" />
      </div>
      <div className={styles.sabicInc}>
        <img className={styles.googleIncChild} alt="" src="/rectangle72.svg" />
        <div className={styles.googleIncItem} />
        <img className={styles.imegeIcon1} alt="" src="/imege51@2x.png" />
      ...
      <div className={styles.riyadBank}>
        <img className={styles.googleIncChild} alt="" src="/rectangle72.svg" />
        <img className={styles.imegeIcon2} alt="" src="/imege52@2x.png" />
        <div className={styles.googleIncItem} />
      ...
      <div className={styles.stcInc}>
        ...
        <div className={styles.dribbbleLogo}>
          ...
          <img className={styles.imegeIcon3} alt="" src="/imege47@2x.png" />
        </div>
      ...
      <div className={styles.microsoft}>
        <img className={styles.googleIncChild} alt="" src="/rectangle72.svg" />
        <div className={styles.googleIncItem} />
        <img className={styles.imegeIcon4} alt="" src="/imege53@2x.png" />
