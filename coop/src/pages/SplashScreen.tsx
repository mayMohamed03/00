...
const SplashScreen: FunctionComponent = () => {
  return (
    <div className={styles.splashScreen}>
      <img className={styles.imegeIcon} alt="" src="/imege33@2x.png" />
      ...
      <img className={styles.imegeIcon1} alt="" src="/imege34.svg" />
      <img className={styles.buttonIcon} alt="" src="/button16.svg" />
