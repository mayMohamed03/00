  ...
  return (
    <div className={styles.chat}>
      <div className={styles.chat2}>
        ...
        <img className={styles.imegeIcon} alt="" src="/imege28@2x.png" />
        <div className={styles.text}>Morning, Can i help you ?</div>
        <div className={styles.text1}>09:31 am</div>
      </div>
      <div className={styles.chat3}>
        <img className={styles.chat3Child} alt="" src="/rectangle19.svg" />
        <img className={styles.imegeIcon1} alt="" src="/imege28@2x.png" />
      ...
      <div className={styles.chat1}>
        <img className={styles.chat1Child} alt="" src="/rectangle20.svg" />
      ...
      <div className={styles.chat11}>
        <img className={styles.chat1Item} alt="" src="/rectangle21.svg" />
        ...
        <img
          ...
          alt=""
          src="/double-ceklis1.svg"
        />
      </div>
      <div className={styles.sendMassage}>
        <img
          className={styles.sendMassageChild}
          alt=""
          src="/rectangle22.svg"
        />
      ...
      <div className={styles.jametCvUiuxDesigner}>
        ...
        <div className={styles.pdf}>
          ...
          <img className={styles.pdfItem} alt="" src="/rectangle24.svg" />
          <img className={styles.lineIcon} alt="" src="/line5.svg" />
        ...
        <img
          ...
          alt=""
          src="/double-ceklis2.svg"
        />
      </div>
      <div className={styles.text13}>Today</div>
      <div className={styles.chatChild} />
      <img className={styles.optionsIcon1} alt="" src="/options2.svg" />
      <div className={styles.iconCall}>
        <div className={styles.button} />
        <img className={styles.imegeIcon2} alt="" src="/imege29.svg" />
      </div>
      <img className={styles.iconSearch} alt="" src="/icon-search2.svg" />
